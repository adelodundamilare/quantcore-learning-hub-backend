"""implement rbac and multi-tenancy models

Revision ID: 7b9a436f87f8
Revises: 
Create Date: 2025-09-25 12:18:36.577974
...
def upgrade() -> None:
    ...
    sa.Column('token_type', sa.Enum('PASSWORD_RESET', 'ACCOUNT_VERIFICATION', name='tokentype'), nullable=False),
    sa.Column('expires_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_one_time_tokens_id'), 'one_time_tokens', ['id'], unique=False)
    op.create_index(op.f('ix_one_time_tokens_token'), 'one_time_tokens', ['token'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_one_time_tokens_token'), table_name='one_time_tokens')
